...
namespace MegaPaint
{
    public partial class MainWindow : Form
    {
        ...
        private void SaveFile()
        {
            ...
            new ExtentionFactory().GetInstance(SaveDialog.FileName).Save(SaveDialog.FileName, saveFile);
        ...
        private void LoadFile()
        {
            ...
            ExtentionFactory factory = new ExtentionFactory();
            ...
            Clear_Drawing_area();
            DrawArea = new Bitmap(openFD.FileName);
            Drawing_pb.Image = DrawArea;
